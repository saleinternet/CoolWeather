package com.csw.android.coolweather.activity;
...
import com.csw.android.coolweather.R;
...
import com.csw.android.coolweather.util.HttpCallbackListener;
import com.csw.android.coolweather.util.HttpUtil;
import com.csw.android.coolweather.util.Utility;
...
public class ChooseAreaActivity extends Activity {
    ...
    /**
     * 查询全国所有省，优先从数据库中查询，如果没有，再去服务器查询
     * */
    ...
    /**
     * 查询选中省所有市，优先从数据库中查询，如果没有，再去服务器查询
     * */
    ...
    /**
     * 查询选中市所有县，优先从数据库中查询，如果没有，再去服务器查询
     * */
    ...
    private void queryFromServer(final String code, final String type) {
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                Log.i("CoolWather", result +"##"+response);
    ...
    /**
     * 捕获Back按键据，根据当前的级别来判断，此时应该返回市列表、省列表、还是直接退出
     * */
    @Override
